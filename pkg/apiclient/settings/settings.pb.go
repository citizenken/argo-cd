...
type Settings struct {
	...
	WorkflowsUrl            string                             `protobuf:"bytes,13,opt,name=workflowsUrl,proto3" json:"workflowsUrl,omitempty"`
	KustomizeVersions       []string                           `protobuf:"bytes,14,rep,name=kustomizeVersions,proto3" json:"kustomizeVersions,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                           `json:"-"`
	XXX_unrecognized        []byte                             `json:"-"`
	XXX_sizecache           int32                              `json:"-"`
}
...
func (m *Settings) GetWorkflowsUrl() string {
	if m != nil {
		return m.WorkflowsUrl
	}
	return ""
}
...
var fileDescriptor_a480d494da040caa = []byte{
	...
	,
}
...
func (m *Settings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.WorkflowsUrl) > 0 {
		i -= len(m.WorkflowsUrl)
		copy(dAtA[i:], m.WorkflowsUrl)
		i = encodeVarintSettings(dAtA, i, uint64(len(m.WorkflowsUrl)))
		i--
		dAtA[i] = 0x6a
	}
...
func (m *Settings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WorkflowsUrl", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WorkflowsUrl = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
